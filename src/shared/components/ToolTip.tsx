  ...
  return (
    ...
    >
      <div className="relative min-w-[5rem] rounded-[0.5rem] shadow-[0_0_0.25rem_0_rgba(0,0,0,0.3)]">
        <span className="bg-white-default block w-[1rem] h-[1rem] rotate-[45deg] absolute z-[1] top-0 left-[50%] -translate-x-1/2 -translate-y-1/2 shadow-[0_0_0.25rem_0_rgba(0,0,0,0.3)]" />
        <div className="relative z-[1] rounded-[0.5rem] bg-white-default">
          {children}
        </div>
      </div>
    </div>
